...
public class PlayerController : MonoBehaviour{
	...
	void Start(){
		...
		Global.countPlayer1 = 0; //setting count
	...
	void OnTriggerEnter(Collider other){
		if (other.gameObject.CompareTag("Pick Up")){
			...
			Global.countPlayer1 = Global.countPlayer1 + 1;//increment the count for every collision, we want to use Unity's UI element to display the count
	...
	void SetCountText(){//updates count and potential win
		countText.text = "Player 1 Count: " + Global.countPlayer1.ToString();
	}
